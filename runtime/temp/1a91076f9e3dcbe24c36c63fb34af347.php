                ...
                <div class="new_m">
                    ...
                    <div class="n_m">
                        <div class="title">
                            ...
                            <p class="name"><a href='article.html?id=<?php echo $list2["$k"]["id"]; ?>'><?php echo $list2["$k"]['title']; ?></a></p>
                        </div>
                        <div class="des">
