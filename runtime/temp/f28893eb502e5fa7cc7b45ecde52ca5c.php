                ...
                <div class="new_m">
                    ...
                    <div class="n_m">
                        <div class="title">
                            ...
                            <p class="name"><a href='article.html?id=<?php echo $list3["$k"]["id"]; ?>'><?php echo $list3["$k"]['title']; ?></a></p>
                        </div>
                        <div class="des">
