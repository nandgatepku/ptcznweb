			...
			<div class="container-fluid">
					...
					<ul class="nav top-menu">
                        ...
                        <li class="dropdown" id="header_inbox_bar">
                            ...
                            <ul class="dropdown-menu extended inbox">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo"><img src=".//ptcznweb/public/static/img/back/avatar-mini.png" alt="avatar" /></span>
									<span class="subject">
                ...
                <div class="top-nav ">
                    <ul class="nav pull-right top-menu" >
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/ptcznweb/public/static/img/back/avatar1_small.jpg" alt="">
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a href="<?php echo url('Back/logout'); ?>"><i class="icon-key"></i> Log Out</a></li>
							</ul>
						</li>
		...
		<div id="sidebar" class="nav-collapse collapse">
			...
			<ul class="sidebar-menu">
				<li class="has-sub active">
                    ...
                    <ul class="sub">
                        <li class="active"><a class="" href="#">Dashboard 1</a></li>
                        <li><a class="" href="#">Dashboard 2</a></li>
				...
				<li class="has-sub">
					...
					<ul class="sub">
						<li><a class="" href="#">General</a></li>
						<li><a class="" href="#">Buttons</a></li>

						<li><a class="" href="#">Tabs & Accordions</a></li>
						<li><a class="" href="#">Typography</a></li>
						<li><a class="" href="#">Tree View</a></li>
						<li><a class="" href="#">Nestable List</a></li>
					</ul>
				</li>
				<li class="has-sub">
					<a href="javascript:;" class="">
					...
					<ul class="sub">
                        ...
                        <li><a class="" href="#">Data Table</a></li>
                        <li><a class="" href="#">Grids</a></li>
                        <li><a class="" href="#">Visual Charts</a></li>
                        <li><a class="" href="#">Conversations</a></li>
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub">
                        <li><a class="" href="#">Form Layouts</a></li>
                        <li><a class="" href="#">Form Components</a></li>
                        <li><a class="" href="#">Form Wizard</a></li>
                        <li><a class="" href="#">Form Validation</a></li>
                        <li><a class="" href="#">Dropzone File Upload </a></li>
                    </ul>
                </li>
				<li class="has-sub">
	               <a href="javascript:;" class="">
	               ...
	               <ul class="sub">
	                  <li><a class="" href="#">Font Awesome</a></li>
                      <li><a class="" href="#">Glyphicons</a></li>
	               </ul>
	            </li>
				<li class="has-sub">
					<a href="javascript:;" class="">
					...
					<ul class="sub">
						<li><a class="" href="#"> Google Maps</a></li>
						<li><a class="" href="#"> Vector Maps</a></li>
					</ul>
				</li>
				<li class="has-sub">
					<a href="javascript:;" class="">
                    ...
                    <ul class="sub">
                        ...
                        <li><a class="" href="#">Sidebar Closed Page</a></li>
                        <li><a class="" href="#">Coming Soon</a></li>
                ...
                <li class="has-sub">
                    ...
                    <ul class="sub">
                        <li><a class="" href="#">Lock Screen</a></li>
                        <li><a class="" href="#">Profile</a></li>
                        <li><a class="" href="#">Invoice</a></li>
                        <li><a class="" href="#">Pricing Tables</a></li>
                        <li><a class="" href="#">FAQ</a></li>
                        <li><a class="" href="#">404 Error</a></li>
                        <li><a class="" href="#">500 Error</a></li>
                    </ul>
                </li>
				<li><a class="" href="#"><span class="icon-box"><i class="icon-user"></i></span> Login Page</a></li>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
		<!-- END SIDEBAR -->
							...
							<div class="widget">
								...
								<div class="widget-body">
									<div id="site_statistics_loading">
										<img src="/ptcznweb/public/static/img/back/loading.gif" alt="loading" />
									</div>
								...
								<div class="widget-body">
                                    <div class="timeline-messages">
                                            ...
                                            <div class="msg-time-chat">
                                                <a class="message-img" href="#"><img alt="" src="/ptcznweb/public/static/img/back/avatar1.jpg" class="avatar"></a>
                                            ...
                                            <!-- Comment -->
                                            <div class="msg-time-chat">
                                                <a class="message-img" href="#"><img alt="" src="/ptcznweb/public/static/img/back/avatar2.jpg" class="avatar"></a>
