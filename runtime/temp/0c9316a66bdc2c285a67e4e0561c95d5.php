    	...
    	<div class="scd_ml">
            ...
            <div class="ctn">
                ...
                <div class="ctn_m">
                    ...
                    <br/>
                    <div style="text-align:center"><img src="/ptcznweb/public/static/upload/pic6.jpg" width="540" height="295" alt=""/></div>
                    <br/>
                    <p><?php echo $arti['content']; ?></p>
                    <br/>
                </div>
